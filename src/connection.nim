## RTT-Secure Connection Module - RmnJL Security Framework
# Secure connection management with anti-detection and anti-hijack features
        ...
        block:
            let res =
                ...
                of SocketScheme.Secure:
                    ...
                    when compiles(TLSFlags.CustomStopAfterHandShake):
                        let flags: set[TLSFlags] = {TLSFlags.CustomStopAfterHandShake}
                    else:
                        let flags: set[TLSFlags] = {TLSFlags.NoVerifyHost}
